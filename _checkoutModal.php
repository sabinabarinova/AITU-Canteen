        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6 mb-0">
                        <b><label for="zipcode">Table number(optional):</label></b>
                        <input type="number" class="form-control" id="zipcode" name="zipcode" placeholder="xx"  pattern="[0-9]{6}" maxlength="6">                    
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="checkout" class="btn btn-outline-success"><strong>Order</strong></button>
                    <button type="button" class="btn btn-outline-danger" data-dismiss="modal"><strong>Cancel</strong></button>
