...
echo '<nav class="navbar navbar-expand-lg navbar-light bg-info ">
  <div class="container-fluid">
      ...
      <img src="img/logoo.jpg" width="30" height="30"  class="d-inline-block align-top rounded-circle" alt="">
      ' .$systemName.'
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form method="get" action="/AITUCanteen/search.php" class=" d-flex my-2 my-lg-0 mx-3">
        ...
        echo '<a href="viewCart.php"><button type="button" class="btn btn-dark mx-2" title="MyCart"><strong>
          ...
          </svg><i class="bi bi-cart ">Cart(' .$count. ')</strong></i>
        </button></a>';
        ...
        if($loggedin){
          ...
          echo '
          <button type="button" class="btn  btn-outline-light mx-2"  data-toggle="modal" data-target="#loginModal">Login</button>
          <button type="button" class="btn  btn-outline-light mx-2"  data-toggle="modal" data-target="#signupModal">SignUp</button>';
        }
