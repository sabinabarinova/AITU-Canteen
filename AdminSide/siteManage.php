		...
		<div class="card-body">
			<form action="partials/_siteManage.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="contact1" name="contact1" value="' .$contact1. '"  pattern= "[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
                </div>
                <div class="form-group">
                    <label for="contact" class="control-label">Contact-2(optional)</label>
                    <input type="tel" class="form-control" id="contact2" name="contact2" value="' .$contact2. '"  pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}">
                </div>
                <div class="form-group">
