            ...
            <div class="jumbotron p-3 mb-3" style="display: flex; justify-content:center; width: 28%;border-radius: 50px;margin: 0 auto;">
                <div class="user-info">
                    ...
                    <form action="partials/_manageProfile.php" method="POST">
                        <small>Remove Image: </small><button type="submit" class="btn btn-outline-info" name="removeProfilePic" style="font-size: 12px;padding: 3px 8px;border-radius: 9px;"><strong>Remove</strong></button>
                    </form>
                    <form action="partials/_manageProfile.php" method="POST" enctype="multipart/form-data" style="margin-top: 7px;">
                        <div class="upload-btn-wrapper">
                            ...
                            <button class="btn btn upload">Choose</button>
                            <input type="file" name="image" id="image" accept="image/*">
                        </div>
                        <button type="submit" name="updateProfilePic" class="btn btn-outline-info" style="margin-top: -20px;font-size: 15px;padding: 3px 8px;"><strong>Update</strong></button>
                    </form>
                    ...
                    <ul class="meta list list-unstyled" style="text-align:center;">
                        ...
                        <li class="my-2"><a href="partials/_logout.php"><button class="btn btn-outline-info" style="font-size: 15px;padding: 3px 8px;"><strong>Logout</strong></button></a></li>
                    </ul>
                </div>
            </div>
            <div class="content-panel mb-3" style="display: flex;justify-content: center;">
                <div class="border p-3" style="border: 2px solid rgba(0, 0, 0, 0.1);border-radius: 1.1rem;background-color: aliceblue;">
                    ...
                    <form action="partials/_manageProfile.php" method="post">
                        ...
                        <button type="submit" name="updateProfileDetail" class="btn btn-outline-info"><strong>Update</strong></button>
                    </form>
                </div>
            </div>
        </div>
