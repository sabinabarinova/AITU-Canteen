...
<html lang="en">
  ...
  <?php include 'partials/_nav.php';?>
      ...
      <div class="contact2" style="background-image:url(img/canteen.jpg);height: 400px;" id="contact">
        <div class="container" >
          <div class="row contact-container">
            <div class="col-lg-12">
              <div class="card card-shadow border-info mb-4">
                <div class="row">
                  <div class="col-lg-8">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text" id="basic-addon">+7
                                      </span>
                                    </div>
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-info">
                    <br></br>
                          <div class="detail-box p-4">
                            ...
                            <p class="text-white op-7">+7 ' .$contact1. '
                              <br> +7 ' .$contact2. '</p>
